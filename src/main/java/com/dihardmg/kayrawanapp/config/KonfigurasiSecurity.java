...
public class KonfigurasiSecurity extends WebSecurityConfigurerAdapter {
	 ...
	 * throws Exception { auth.authenticationProvider(daoAuthenticationProvider());
	 * }
	 * 
	 ...
	 * @Bean
	 * 
	 * @Override public UserDetailsService userDetailsService() { JdbcDaoImpl
	 * userDetails = new JdbcDaoImpl(); userDetails.setDataSource(dataSource);
	 * userDetails.setUsersByUsernameQuery(SQL_LOGIN);
	 * userDetails.setAuthoritiesByUsernameQuery(SQL_ROLE); return userDetails; }
	 * 
    ...
    protected void configure(HttpSecurity http) throws Exception {
		 ...
		 * .antMatchers("/offer/**").hasAnyRole("MASTER_OFFER")
		 ...
		 * .antMatchers("/kategoribuktikegiatan/**").hasAnyRole(
		 * "MASTER_KATEGORI_BUKTI_KEGIATAN")
		 * .antMatchers("/jenisbuktikegiatan/**").hasAnyRole(
		 * "MASTER_JENIS_BUKTI_KEGIATAN")
		 * .antMatchers("/poinkegiatan/**").hasAnyRole("MASTER_POIN_KEGIATAN")
		 * .antMatchers("/jenisDokumenPengajuan/**").hasAnyRole(
		 * "MASTER_JENIS_DOKUMEN_PENGAJUAN")
		 * 
